...
const STAGE = { id:'대기', rows:[ {z:96, xs:[4,6,8,10,12,14]}, {z:99, xs:[4,6,8,10,12,14]} ] };
/* 외부 입고 하차 구역 — 입고 파렛트가 놓이는 자리 */
const INBOUND = { z:92.5, xs:[4,6,8,10,12,14]};
/* 야드 빈 파렛트 열 (열차 재료) */
const EMPTY_ROW = { x:-36, z:100, n:8 };
/* 교차로 — 통로 끝. 정지 후 경적. */
const INTERSECTIONS = [
  {x:-36, z:12.5}, {x:36, z:12.5}, {x:-36, z:21.0}, {x:36, z:21.0},
  {x:-36, z:30.0}, {x:36, z:30.0}, {x:-36, z:39.5}, {x:36, z:39.5},
  {x:0, z:12.5}, {x:0, z:30.0}, {x:0, z:43.0}, {x:0, z:57.5}
];
const INTER_R = 3.6;
